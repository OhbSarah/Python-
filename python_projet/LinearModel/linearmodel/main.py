...
visualization.plot_pairs(data) #un peu long environ 2min pour afficher
...
#Afficher les coefficients ainsi que les t-stats et les erreurs standars pour chaque coefficient en dehors de l'Intercepte
#et enfin le coefficient de determination
...
visualization.qqplot(resi, distribution='norm', dist_params=(0, 1)) #long à s'afficher environ 5 à 20min
